    ...
    <header className={cn(
      ...
      <div className="flex items-center space-x-4 flex-1">
        ...
        <div className="relative max-w-md">
          ...
          />
          <kbd className="pointer-events-none absolute right-3 top-1/2 hidden h-5 -translate-y-1/2 select-none items-center gap-1 rounded-lg border bg-muted px-1.5 font-mono text-[10px] font-medium opacity-100 sm:flex">
